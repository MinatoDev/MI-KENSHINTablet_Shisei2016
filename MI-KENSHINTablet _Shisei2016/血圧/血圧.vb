...
#Region "イベント"
    ...
    Public Overrides Sub Tuuban_TubanDecision(personID As String, tuban As String)
        ...
        If Not tuban.Equals(String.Empty) Then
            ...
            txt最高血圧値1.Focus()
        Else
            txt最高血圧値1.Enabled = False
            txt最高血圧値2.Enabled = False
            txt最低血圧値1.Enabled = False
            txt最低血圧値2.Enabled = False

            lbl最高血圧値1.Enabled = False
            lbl最高血圧値2.Enabled = False
            lbl最低血圧値1.Enabled = False
            lbl最低血圧値2.Enabled = False
    ...
    Private Sub 血圧_Quit() Handles Me.Quit
        Using msgwin As MessageWindow = New MessageWindow()
            msgwin.IconImage = CommonConst.QUESTION
            msgwin.ButtonStyle = CommonConst.YES_NO
