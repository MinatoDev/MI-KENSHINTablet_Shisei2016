...
#Region "プロパティ"
    ...
    ''' 学校視力Logicクラス
    ''' </summary>
    Private Property Logic As 学校視力Logic
...
#Region "コンストラクタ"
    ...
    Public Sub New()
        ...
        Try
            Logic = New 学校視力Logic(Me)
            Me.KenshinName = CommonConst.SIRYOKU_SCHOOL
...
#Region "登録ボタンクリックイベント"
    ...
    ''' <param name="e"></param>
    ''' <remarks></remarks>
    Private Sub 学校視力_Load(sender As Object, e As EventArgs) Handles Me.Load
...
#Region "終了イベント"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Private Sub 学校視力_Quit() Handles Me.Quit
        Using msgwin As MessageWindow = New MessageWindow()
            msgwin.IconImage = CommonConst.QUESTION
            msgwin.ButtonStyle = CommonConst.YES_NO
