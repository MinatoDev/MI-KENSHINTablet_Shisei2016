...
#End Region
    ...
    Friend Function IsExist(id As String) As Boolean
        ...
        If Dac.IsInspectionCode(id, AppSettings("NakedEyeR")) OrElse Dac.IsInspectionCode(id, AppSettings("NakedEyeL")) OrElse Dac.IsInspectionCode(id, AppSettings("CorrectedEyeR")) OrElse Dac.IsInspectionCode(id, AppSettings("CorrectedEyeL")) Then
            Return True
        End If
        Return False
    End Function
